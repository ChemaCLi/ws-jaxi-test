...
/**
 * @route           GET /
 * @description     Devuelve todos las tasks activos 
 * @access          Public       
 */
router.get('/', (req, res) => {
     try {
          ...
          Task.getActive()
               ...
               .catch(err => {
                    res
                         ...
                         .json(response.getJsonResponseError(sc.system.failure, msg.error, `error.tasks.index ${err}`, null))
               })
     }
     catch (err) {
          res
...
router.post('/', (req, res) => {
     try {
          ...
          columns.project_int_id = req.body.project_int_id ? req.body.project_int_id : null
          columns.int_priority = req.body.int_priority ? req.body.int_priority : 0
...
router.put('/', (req, res) => {
     try {
          ...
          if(req.body.hasOwnProperty('project_int_id'))
               columns.project_int_id = req.body.project_int_id ? req.body.project_int_id : 0
